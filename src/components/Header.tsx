        ...
        <header className="bg-white sticky top-0 z-50 py-2.5">
            <div className="mx-4 md:mx-8 lg:mx-12">            <div className="flex justify-between items-center">
                ...
                <div className="flex items-center">
                    ...
                    <div className="md:hidden">
                        {isAuthenticated ? (
                            <Link href="/profile" className="flex items-center text-sm font-medium text-gray-700 px-3 py-2">
            ...
            {isMenuOpen && (
                ...
                <nav className="flex flex-col space-y-4">
                    ...
                    <Link href="/scholarships/search" className="text-gray-700 hover:text-primary-600 font-medium">
                        Scholarships
                    </Link>
                    <Link href="/admissions" className="text-gray-700 hover:text-primary-600 font-medium">
                        Admissions
                    </Link>
